...
function setup() {
    ...
    block6=new block(675,220)
    block7=new block(625,220)
    block8=new block(575,220)
    block9=new block(525,220)
    block10= new block(650,170)
    block11=new block(600,170)
    block12=new block(550,170)
    block13=new block(575,120)
    block14=new block(625,120)
    block15=new block(600,70)

    block16=new block(1050,270)
    block17=new block(1000,270)
    block18= new block(1100,270)
    block19= new block(1025,220)
    block20= new block(1075,220)
    block21=new block(1050,170)
